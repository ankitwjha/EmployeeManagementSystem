...
const AcceptTask = ({data, employeeId, updateTaskStatus}) => {
  return (
    <div className='flex-shrink-0 w-full md:w-[320px] p-5 sm:p-6 backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl flex flex-col justify-between shadow-xl min-h-[220px] md:min-h-[250px] hover:border-amber-500/30 transition-all duration-300 relative overflow-hidden group'>
